import 'package:eccapp/forms/malhaardisplay.dart';
...
class MalhaarApp extends StatefulWidget {
  const MalhaarApp({super.key});

  @override
  State<MalhaarApp> createState() => _MalhaarAppState();
}

class _MalhaarAppState extends State<MalhaarApp> {
  ...
  Future<void> _createData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('malhaar').doc();
    //create map
  ...
  Future<void> _fetchDataAndNavigate() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('malhaar').get();
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MyMalhaarScreen(documents: documents),
      ),
    );
  }
          ...
          child: SafeArea(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [ Colors.white, Color.fromARGB(255, 86, 221, 210),],
              ),
            ),
                  ...
                  child: Column(
                    children: <Widget>[
                          ...
                          decoration: const InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: Color.fromARGB(255, 166, 214, 236),
                                      width: 5.0))),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          decoration: const InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                      color: Color.fromARGB(255, 164, 215, 238),
                                      width: 5.0))),
                      ...
                      ButtonBar(
                        ...
                        children: <Widget>[
                          Text("BScIT",
                          style: TextStyle(color:  Color.fromARGB(255, 51, 63, 225)),),
                          Radio(
                            value: "BScIT",
                            groupValue: selectedRadio,
                            activeColor: Color(0xFF063455),
                            onChanged: (val) {
                              print("Radio $val");
                        ...
                        children: <Widget>[
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary:Color.fromARGB(255, 51, 63, 225),
                            ),
                          ),
                          //ElevatedButton(
                          //     onPressed: (() {

import 'package:eccapp/forms/mathsdisplay.dart';
...
class _MathsAppState extends State<MathsApp> {
  ...
  Future<void> _createData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('mathematika').doc();
    //create map
  ...
  Future<void> _fetchDataAndNavigate() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('mathematika').get();
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MyMathsScreen(documents: documents),
      ),
    );
  }

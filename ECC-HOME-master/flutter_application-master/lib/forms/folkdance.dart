import 'package:eccapp/forms/folkdisplay.dart';
...
class FolkyApp extends StatefulWidget {
  const FolkyApp({super.key});

  @override
  State<FolkyApp> createState() => _FolkyAppState();
}

class _FolkyAppState extends State<FolkyApp> {
  ...
  Future<void> _createData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('folkdance').doc();
    //create map
  ...
  Future<void> _fetchDataAndNavigate() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('folkdance').get();
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MyFolkScreen(documents: documents),
      ),
    );
  }

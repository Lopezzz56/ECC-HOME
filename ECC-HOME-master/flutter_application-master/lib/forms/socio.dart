import 'package:eccapp/forms/socialdisplay.dart';
...
class SocioApp extends StatefulWidget {
  const SocioApp({super.key});

  @override
  State<SocioApp> createState() => _SocioAppState();
}

class _SocioAppState extends State<SocioApp> {
  ...
  Future<void> _createData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('socialhour').doc();
    //create map
  ...
  Future<void> _fetchDataAndNavigate() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('socialhour').get();
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MySocialHScreen(documents: documents),
      ),
    );
  }

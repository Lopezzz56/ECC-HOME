import 'package:eccapp/forms/fitoordisplay.dart';
...
class FitoorApp extends StatefulWidget {
  const FitoorApp({super.key});

  @override
  State<FitoorApp> createState() => _FitoorAppState();
}

class _FitoorAppState extends State<FitoorApp> {
  ...
  Future<void> _createData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('fitoor').doc();
    //create map
  ...
  Future<void> _fetchDataAndNavigate() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('fitoor').get();
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MyFitoorScreen(documents: documents),
      ),
    );
  }
